...
def register_commands() -> str:
    ...
    try:
        ...
        menu = command_menu()
        # Telegram's set_my_commands accepts at most 100 commands. /help lists
        # the full set (send_reply splits it); here we cap the "/" autocomplete
        # menu to the first 100 to fit. Commands beyond that still work when
        # typed and appear in /help.
        menu = menu[:100]
